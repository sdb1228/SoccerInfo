...
# Scrapes the UYSA site for the teamId, name, and division and puts it into the localhost postgresdb
#
#
...
def UYSAGirlsTeamUpdate():
	...
	url = 'http://uysa.affinitysoccer.com/tour/public/info/accepted_list.asp?sessionguid=&tournamentguid=714A94A4-B78D-421F-9EC7-0FCF25060908&show=girls'
...
def UYSAGirls_run():
	...
	draft_slack_message("UYSA Girls", "success")
