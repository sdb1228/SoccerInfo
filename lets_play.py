...
if os.environ['TEST'] == "1":
  ...
  create_games_query = """CREATE TABLE games(id SERIAL, awayteam TEXT, hometeam TEXT, gamesdatetime TEXT, field TEXT, hometeamscore INT, awayteamscore INT, PRIMARY KEY(id));
